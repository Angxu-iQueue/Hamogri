...
const Cart = () => {
  ...
  const generateReceipt = () => {
    ...
    const addressLines = doc.splitTextToSize(userAddress, 60); // Adjust width as needed
    addressLines.forEach((line, index) => {
      doc.text(line, 20, 60 + index * 10); // Adjust startY and line spacing (10) as needed
    });
